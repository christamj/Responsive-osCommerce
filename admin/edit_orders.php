...
//              document.write("<li><a href=\"javascript:newOrderEmail()\">Send Confirmation Email</a></li>");
...
<!- eof 5.0.8 -->							
			...
			<li><?php echo tep_draw_button(IMAGE_BACK, 'arrow-1-w', tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('action'))), null)?></li>
		  </ul>
